...
<html lang="en">
	<head>
		...
		<spring:url value="/resources/core/mod/salesSCRLeads/salesSCRLeads.css?v=1.0.4" var="salesSCRLeadsCSS" />
		<spring:url value="/resources/core/mod/salesSCRLeads/salesSCRLeads.js?v=1.0.16" var="salesSCRLeadsJS" />
		...
		<link rel="stylesheet" href="${salesSCRLeadsCSS}">
	...
	<body class="layout layout-header-fixed">
				...
				<div class="layout-content-body">
					<div class="title-bar">
						<h1 class="title-bar-title">
							<span class="d-ib">SCR Leads<small></span>
		...
		<script src="${salesSCRLeadsJS}"></script>
