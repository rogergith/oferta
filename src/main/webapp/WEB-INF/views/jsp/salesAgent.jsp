...
<html lang="en">
	<head>
		...
		<spring:url value="/resources/core/mod/salesAgent/salesAgent.css?v=1.0.4" var="salesAgentCSS" />
		<spring:url value="/resources/core/mod/salesAgent/salesAgent.js?v=1.0.16" var="salesAgentJS" />
		...
		<link rel="stylesheet" href="${salesAgentCSS}">
	...
	<body class="layout layout-header-fixed">
				...
				<div class="layout-content-body">
					<div class="title-bar">
						<h1 class="title-bar-title">
							<span class="d-ib">SDI Leads<small></span>
		...
		<script src="${salesAgentJS}"></script>
	</body>
</html>