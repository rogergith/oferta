...
<spring:url value="/resources/core/mod/report/report.css" var="reportCSS" />
<spring:url value="/resources/core/mod/report/report.js" var="reportJS" />
...
%>
							...
							<div class="input-with-icon">
								<button class="btn btn-primary" type="button"
									style="margin-left: 15px;" id="generateReport">Generate Report
									</button>
							</div>
