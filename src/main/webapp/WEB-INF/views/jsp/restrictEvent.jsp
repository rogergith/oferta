...
<body class="layout layout-header-fixed">
		...
		<div class="layout-content">
			<div class="layout-content-body ">
				...
				<div id="restrict-event-container-form" style="margin-top: 5em;">
					<form id="restrict-event-form" enctype="multipart/form-data">
								...
								<div class="demo-form-wrapper">
									...
									<div class="title-bar  stripe-form-elements"
										...
										<div class="title-bar-title">
											<h4>
												<span class="d-ib">Enter the list of users who can
													access to this event</span>
											</h4>
										</div>
									</div>
									<div id="event-data-massive" class="form form-horizontal">
										...
										<div id="massive-input-container"
											...
											<label for="payment-method" class="col-sm-4  control-label">File:</label>
											<div class="col-sm-6 col-md-4">
												<input type="file" id='customers' name='customers' required />
											</div>
										</div>
										<div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
											<div class="form-group">
												<button class="btn btn-primary btn-block" id="registerUsers">Register
													Customers</button>
												<div id="restrict-event-spinner"
	...
	<script src="${restrictEventJs}"></script>
