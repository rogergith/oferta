...
<spring:url value="/resources/core/mod/admin/admin.js?v=1.0.6" var="admin" />
<spring:url value="/resources/core/mod/users/users.css?v=1.0.7" var="userCSS" />
<spring:url value="/resources/core/mod/users/users.js?v=1.0.11" var="userJS" />
<spring:url value="/resources/core/mod/users/userAccess.js?v=1.0.6" var="userAccessJS" />
...
<spring:url value="/resources/core/js/clipboard.min.js" var="clipboardJs" />
<meta charset="UTF-8">
			...
			<div class="layout-content-body">
				<div class="title-bar">
					<h1 class="title-bar-title">
						<span class="d-ib">Users <small></span>
					...
					<div class="col-xs-12">
						<div class="card">
							...
							<div class="filters" style="padding: 20px 30px 10px 10px;">
							 <form id="users-filter-form-lifecyle">
							<!-- 	<div class="input-group input-daterange"
								...
								<div class="container-filter-inputs">
										<div style="padding-right: 5px;">
											<input type="text" class="form-control2 form-control" id="fname" name="fname" placeholder="Name"> <br>
											<span class="custom-message-error"></span>
										</div>
										<div style="padding-right: 5px;">
											<input type="text" class="form-control2 form-control" id="lname" name="lname" placeholder="Last Name"><br>
											<span class="custom-message-error"></span>
										</div>
										<div style="padding-right: 5px;">
											<input type="text" class="form-control2 form-control" id="email" name="email" placeholder="Email"> <br>
											<span class="custom-message-error"></span>
										</div>
										<div style="padding-right: 5px;">
											<input type="text" class="form-control2 form-control" id="userId" name="userId" placeholder="UserId"> <br>
											<span class="custom-message-error"></span>
										</div>
										<div style="padding-right: 5px;">
											<input type="text" class="form-control2 form-control" id="phoneNumber" name="phoneNumber" maxlength="14" placeholder="Phone"> <br>
											<span class="custom-message-error"></span>
										</div>
								</div>
							...
							<div class="input-with-icon" style="padding-top:10px;">
								<button class="btn btn-primary" type="button"
									 id="generateUserSearchLifeCycle">Generate Search</button>
							</div>
...
<!--  MODAL -->
		<div class="layout-footer">
			<div class="layout-footer-body">
				<small class="version">Version 1.0.5</small> <small
