	...
	<div class="donation-form" style="display: none;">
		<form action="" method="POST" id="payment-form">
		  <span class="payment-errors"></span>
		      	<input type="text" size="20" id="card-stripe" data-stripe="number">
		      	<input type="text" size="2" id="month-stripe" data-stripe="exp_month">
		    	<input type="text" size="2" id="year-stripe" data-stripe="exp_year">
		     	<input type="text" size="4" id="cvv-stripe" data-stripe="cvc">	
		      	<input type="text" size="6" id="zip-stripe" data-stripe="address_zip">
		      	<input type="text" id="name-stripe" data-stripe="name">
				<input type="text" id="city-stripe" data-stripe="address_city">
				<input type="text" id="state-stripe" data-stripe="address_state">
				<input type="text" id="country-stripe" data-stripe="address_country">
				<input type="text" id="email-stripe" data-stripe="emailAddress">
		</form>		
	</div>
