...
<title>${title}</title>
    ...
    <spring:url value="/resources/core/mod/white-list/index.js?v=1.0.1" var="myFileJs"/>
    <spring:url value="/resources/core/mod/white-list/index.css?v=1.0.1" var="myFileCSS"/>
		...
		<div class="modal-container">
			<div class="modal-content scroll-design scroll-small">
                ...
                <div class="content success" style="display:none">
                    <div class="titulo">The email was successfully added</div>
                    <div class="input-section">
                        <button class="btn btn-primary btn-block" id="source-next-click">
                            <span class="normal">Add New Email</span>
                        </button>
                    </div>
				...
				<div class="content register">
					<div class="titulo">Register Email in WhiteList</div>

                    <div class="input-section">
                        <label>Email</label>
                        <input type="text" name="text" id="source-name" placeholder="Email">
                        <div id="source-name-error" class="myErrorModal"></div>
                    </div>

                    <div class="input-section">
                        <label>Reason</label>
                        <input type="text" name="text" id="source-reason" placeholder="Reason">
                        <div id="source-reason-error" class="myErrorModal"></div>
                    </div>
                    

                    <div class="input-section">
                        <button class="btn btn-primary btn-block" id="source-insert-click">
                            <span class="normal">Add Email</span>
                            <span class="loading">
                                Loading ...
                            </span>
                        </button>
        ...
        <div class="layout-content-body ">
            <div class="title-bar">
                <h1 class="title-bar-title">
                    <span class="d-ib">WhiteList</span> 
                        <span class="d-ib">
