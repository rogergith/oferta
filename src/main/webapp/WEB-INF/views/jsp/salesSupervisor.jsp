...
<html lang="en">
	<head>
		...
		<spring:url value="/resources/core/mod/salesSupervisor/salesSupervisor.css?v=1.0.10" var="salesSupervisorCSS" />
		<spring:url value="/resources/core/mod/salesSupervisor/salesSupervisor.js?v=1.0.16" var="salesSupervisorJS" />
		...
		<link rel="stylesheet" href="${salesSupervisorCSS}">
	...
	<body class="layout layout-header-fixed">
				...
				<div class="layout-content-body">
					<div class="title-bar">
						<h1 class="title-bar-title">
							<span class="d-ib">Lead Manager<small></span>
						...
						<div class="col-xs-12">
							<div class="card">
								...
								<div class="filters" style="padding: 20px 30px 10px 10px;">
									...
									<select id="agents" class="custom-select form-control2 form-control">
										<option value="" selected="selected">Select Agent</option>
										
									</select>
									
									<select id="typeLead" class="custom-select form-control2 form-control">
								...
								<div class="input-with-icon">
									<button class="btn btn-primary" type="button" style="margin-left: 15px;" id="generateSalesSupervisor">
										Generate Report
									</button>
								...
								<div class="bulk-action">
									<div id="bulkActions" style="display:none;">
										<select id="bulkActionSelect" class="custom-select form-control2 form-control">
											...
											<option value="3">Unassign</option>
		...
		<script src="${salesSupervisorJS}"></script>
