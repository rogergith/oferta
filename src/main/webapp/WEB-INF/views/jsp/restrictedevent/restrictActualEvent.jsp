...
<title>${title}</title>
    ...
    <spring:url value="/resources/core/js/restrictedevent/restrictActualEvent.js"
        ...
        <div class="layout-content-body ">
            <div class="title-bar">
                <h1 class="title-bar-title">
                    <span class="d-ib">Restrict Event</span> <span class="d-ib">
            ...
            <div id="restrict-event-container-form" style="margin-top: 5em;">
                ...
                <div class="tab-pane">
                    <div class="row">
                        <div class="col-sm-12 text-center event-setting toggle-setting">
                            <label for="toggle">Restrict event</label>

                            <label class="switch switch-info " id="toggle">
                                <input class="switch-input" type="checkbox" id="toggleRestrict"
                        ...
                        <div class="spinner spinner-primary spinner-lg setting-spinner" style="display:none;"></div>
                    </div>
                ...
                <div id="massive-errors" class="message-error"></div>
            </div>
            <!-- /FORM MASSIVE CUSTOMER -->


            <div id="restrictedDialog" class="mt-5 event-setting" style="margin-top: 12rem; display: none">


                <form id="restrictedActualEventInformation">
                        ...
                        <div class="row gutter-xs">
                            ...
                            <div class="col-xs-6 col-md-4">
                                <div class="panel panel-body text-center" data-toggle="match-height">
                                    <h5>Start date</h5>
                                    <p class="small text-muted">Put the start date for the Event </p>
                                    <div class="input-with-icon">
                                        <input id="initial-date" name="initialDate" class="form-control" type="text" data-provide="datepicker">
                            ...
                            <div class="col-xs-6 col-md-4">
                                <div class="panel panel-body text-center" data-toggle="match-height">
                                    <h5>End date</h5>
                                    <p class="small text-muted">Put the end date for the event.</p>
                                    <div class="input-with-icon">
                                        <input id="end-date" name="endDate" class="form-control" type="text" data-provide="datepicker">
                                        <span class="icon icon-calendar input-icon"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6 col-md-4">
                                <div class="panel panel-body text-center" data-toggle="match-height">
                                    <h5>Number of days of access</h5>
                                    <p class="small text-muted">Put the number of days to access.</p>
                                    <div class="input-with-icon">
                                        <input id="number-days" name="allowedDays" class="form-control" type="text">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6 col-md-4">
                                <div class="panel panel-body text-center" data-toggle="match-height">
                                    <h5>Require sign contract</h5>
                                    <div class="sginature-require-container">
			                             <label class="switch switch-info " id="signature-required">
			                                <input class="switch-input" type="checkbox" id="toggle-signature" onchange="activateSignatureRequired()">
			                                <span class="switch-track"></span>
			                                <span class="switch-thumb"></span>
			                            </label>
                                    </div>
                                    <div class="document-template-container" style="display:none;">
                                    <p class="small text-muted">Document Template ID</p>
                                    <div class="input-with-icon">
                                        <input id="template-id" name="template-id" class="form-control" type="text">
                                    </div>
                                    </div>
                                </div>
                            </div>
...
<div class="theme"></div>
<%
    ArrayList<ListFund> funds = (ArrayList<ListFund>) session.getAttribute("listFund");
    
	    Iterator<ListFund> iterListFund = funds.iterator();
	    String formattedFund = "[";
	    while (iterListFund.hasNext()) {
	          ListFund listFundTmp = iterListFund.next();
	          formattedFund = formattedFund +  "{ id: \"" +  listFundTmp.getId() + " \", fund:\"" + listFundTmp.getName() + "\"},";
	    }
    	formattedFund += "]";
%>
<script type="text/javascript">
    var ErrorActualIdiom = 1;
    var ajaxPath = "/scr-admin/";
...
<script src="${restrictActualEventJs}"></script>
