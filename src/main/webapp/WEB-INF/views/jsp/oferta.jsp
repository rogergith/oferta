...
<spring:url value="/resources/core/mod/elephant/elephant.css?v=1.0.3"
	var="elephant" />
<spring:url value="/resources/core/mod/elephant/elephant.js?v=1.0.3"
	var="elephantJs" />
<spring:url
...
<spring:url
	...
	var="iconsCSS" />
<spring:url
	value="/resources/core/mod/application/application.css?v=1.0.3"
	var="application" />
<spring:url
	value="/resources/core/mod/application/application.js?v=1.0.3"
	var="applicationJs" />
<spring:url value="/resources/core/mod/vendor/vendor.min.css?v=1.0.3"
	var="vendor" />
<spring:url value="/resources/core/mod/vendor/vendor.min.js?v=1.0.3"
	var="vendorJs" />
<spring:url value="/resources/core/js_old/jquery.validate.js?v=1.0.3"
	var="validateJs" />
<spring:url value="/resources/core/css/demo.min.css?v=1.0.3" var="demo" />
<spring:url
	value="/resources/core/mod/datatable/datatable.min.css?v=1.0.3"
	var="dataTableCss" />
<spring:url
	value="/resources/core/mod/datatable/datatable.min.js?v=1.0.3"
	var="dataTableJs" />
<spring:url value="/resources/core/js/init.js?v=1.0.6" var="initJs" />
<spring:url
	value="/resources/core/mod/datatable/dataTables.buttons.min.js?v=1.0.3"
	var="dataTablesbuttons" />
<spring:url
	value="/resources/core/mod/datatable/dataTables.buttons.min.css?v=1.0.3"
	var="dataTablebuttonscss" />
<spring:url value="/resources/core/js/buttons.html5.min.js?v=1.0.3"
	var="dataTablesbuttons5" />
<spring:url value="/resources/core/js/jszip.min.js?v=1.0.3"
	var="jszipJS" />
<spring:url value="/resources/core/js/jquery.mask.min.js?v=1.0.3"
	var="maskJs" />
<spring:url value="/resources/core/mod/admin/admin.js?v=1.0.3"
	var="admin" />
<spring:url value="/resources/core/mod/stripe/stripe.css?v=1.0.3"
	var="stripeCSS" />
<spring:url value="/resources/core/mod/stripe/stripe.js?v=1.0.3"
	var="stripeJS" />
<spring:url
	value="/resources/core/mod/billing-comission/comission.js?v=1.0.3"
	var="comissionJs" />
<spring:url
	value="/resources/core/mod/loading/jquery.loadingModal.min.css?v=1.0.3"
	var="loadingCSS" />
<spring:url
	value="/resources/core/mod/loading/jquery.loadingModal.min.js?v=1.0.3"
	var="loadingJS" />
<spring:url value="/resources/core/js/paymentStripe.js?v=1.0.3"
	var="paymentStripeJs" />
<spring:url value="/resources/core/css_old/call-center.css?v=1.0.3"
	var="callCenterCSS" />
<spring:url value="/resources/core/js/clipboard.min.js?v=1.0.3"
	var="clipboardJs" />
<spring:url value="/resources/core/css/addAttendee.css?v=1.0.3"
	var="addAttendeeCSS" />
<script
	src="https://cdnjs.cloudflare.com/ajax/libs/dayjs/1.11.1/dayjs.min.js"></script>
						...
						<div class="tab-content">
								...
								<div class="col-sm-12">
									<div class="demo-form-wrapper">
										<div class="form form-horizontal">
											...
											<div class="title-bar  stripe-form-elements"
							...
							-->
											...
											<div class="form-group find-email-group">
												...
												<div class="col-sm-6 col-md-4">
													<input type="email" class="form-control special-input"
													...
													<a class="special-button" id="verifyUser"
														...
														</div> <label class="action-find-user active">Find</label>
													</a>
											...
											<div class="form-group">
												...
												<div class="col-sm-6 col-md-4">
													<input placeholder="Name" type="text" class=" form-control"
														id="fname" name="fname" data-error-icon="icon-exclamation">
												</div>
												<div class="custom-message-error"></div>
											</div>
											<div class="form-group">
												<label for="lname" class="col-sm-3 col-md-4 control-label">Last
													Name:</label>
												<div class="col-sm-6 col-md-4">
											...
											<div
												class="form-group form-group-md is-massive-too form-group-source">
														...
														<div id="event-data-form" class="form form-horizontal">
															...
															<div class="form-group form-group-md is-massive-too">
																<label for="payment-method"
																	class="col-sm-4  control-label">Event:</label>
																<div class="col-sm-6 col-md-4">
...
%>
																		<option value=<%=listFundTmp.getId()%>
																			selected="selected"><%=listFundTmp.getName()%></option>
																		<%
	}
%>
															...
															<div id='modify-start-date-container'
																class="form-group start-date-group"
																style="display: none;">
																<div
																	...
																	<label
																		...
																		id="modify-start-date" name="modify-start-date">
																		<span class="custom-control-indicator"></span> <span
																		class="custom-control-label">Modify start date</span>
																	</label>
																</div>
															</div>

															<div class="form-group start-date-input start-date-group"
																style="display: none;">
																<label for="lname"
																	class="col-sm-3 col-md-4 control-label">Start
																	date:</label>
																<div class="col-sm-6 col-md-4">
															...
															<div
																class="form-group form-group-md is-massive-too form-group-source">
																<label for="payment-method"
																	class="col-sm-4  control-label">Source:</label>
																<div class="col-sm-6 col-md-4">
																	<select id="sourceMarketing" name="sourceMarketing"
															...
															<div class="form-group form-group-md is-massive-too"
																style="display: none;">
																<label for="payment-method"
																	class="col-sm-4  control-label">Language:</label>
																<div class="col-sm-6 col-md-4">
															...
															<div class="form-group form-group-md is-massive-too">
																<label for="payment-method"
																	class="col-sm-4  control-label">Mount:</label>
																<div class="col-sm-6 col-md-4">
															...
															<div id="billing-component"
																class="row comission-info-table" style="display: none;">
																			...
																			<ul class="list-group list-group-divided">
																				<li class="list-group-item">
																					<div class="media">
																						<div class="media-middle media-body">
																							...
																							<h4 id="comission-event-amount" class=""></h4>
																						</div>
																						<div class="media-middle media-right">
																							<span class="bg-primary circle sq-40"> <span
																				...
																				<li class="list-group-item">
																					<div class="media">
																						...
																						<div class="media-middle media-right">
																							<span class="bg-primary circle sq-40"> <span
																								class="icon icon-link"></span>
																							</span>
																						</div>
																					</div>
																				</li>
																				<li class="list-group-item coupon-apply"
																					style="display: none;">
																					<div class="media">
																						<div class="media-middle media-body">
																							<h6 class="media-heading">
																								<span>Disccount:</span> <small
																									id="percent-mount"> 15%</small>
																							</h6>
												...
												<div class="col-sm-12">
													<div class="demo-form-wrapper">
														<div class="form form-horizontal">
															...
															<div
																class="form-group form-group-md payment-method-container"
																style="display: none;">
																<label for="payment-method"
																	class="col-sm-4  control-label">Payment method:</label>
																<div class="col-sm-6 col-md-4">
															...
															<div class="form-group form-group-md external-payment"
																style="display: none;">
																<label for="external-payment-method"
																	class="col-sm-4  control-label"></label>
																<div class="col-sm-6 col-md-4">
																	<select id="external-payment-method"
																		name='external-payment-method' class="custom-select">
...
%>
															...
															<div
																class="form-group form-group-md has-feedback external-payment"
																style="display: none;">
																<label for="external-payment-description"
																	class="col-sm-4  control-label">Description:</label>
																<div class="col-sm-6 col-md-4">
																	<textarea class="form-control"
																		id="external-payment-description"
																		name="external-payment-description"
															...
															<div class="form-group split-payment"
																style="display: none;">
																<label for="lname"
																	class="col-sm-3 col-md-4 control-label">Paid
																	amount</label>
																<div class="col-sm-6 col-md-4">
																	<div class="input-with-icon">
																		<input value="0,00" id="paidAmount" name="paidAmount"
																			class="form-control" readonly style="border: none;" />
															...
															<div class="form-group split-payment"
																style="display: none;">
																<label id="lAmount"
																	class="col-sm-3 col-md-4 control-label"></label>
																<div class="col-sm-6 col-md-4">
																	<div class="input-with-icon">
															...
															<div class="form-group split-payment"
																style="display: none;">
																<label for="lname"
																	class="col-sm-3 col-md-4 control-label">Payable
																	amount</label>
																<div class="col-sm-6 col-md-4">
																	<div class="input-with-icon">
																		<input id="payableAmount" type="number"
																			placeholder="0,00" value="0" min="0.00"
																			max="amountToPay" class="form-control"
																			name="payableAmount"
																			oninput="inputChange(this.value)"
																			onkeyup="inputEmpty(this.value)" />
																		<div class="icon icon-usd input-icon"></div>
																		<input id="slid" type="range" min="0" step="1"
																			value="0" oninput="sliderChange(this.value)"
																			style="margin-top: 10px;">
																	</div>
																</div>
																<div id="text-fee"
																	style="margin-top: 7px; display: none;"></div>
															</div>


															<div
																class="form-group stripe-form-elements list-credicard"></div>
																...
																<div class="col-sm-6 col-md-4">
																	<div class="input-with-icon">
																		<input placeholder="Credit Card" type="text"
																			id="cardNumber" class="form-control"
																			name="cardNumber" maxlength="20"
															...
															<div id="save-container"
																class="form-group coupon-group stripe-form-elements card-1"
																style="display: none;">
																<div
																	class="col-sm-offset-3 col-sm-6 col-md-offset-4 col-md-4">
																	<label
																		class="custom-control custom-control-primary custom-checkbox">
																		<input class="custom-control-input" type="checkbox"
																		id="save-credit-card" name="save-credit-card">
																		<span class="custom-control-indicator"></span> <span
																		class="custom-control-label">Save Credit Card</span>
																	</label>
																</div>
															</div>
															...
															<div class="form-group stripe-form-elements card-1">
																...
																<div class="col-sm-6 col-md-4">
																	<div class="input-with-icon">
																		<input type="tel" id="lang-expdate_ph"
																			class="form-control" name="lang-expdate_ph"
															...
															<div class="form-group stripe-form-elements card-1">
																...
																<div class="col-sm-6 col-md-4">
																	<div class="input-with-icon">
																		<input type="tel" id="lang-cvv_ph"
																			class="form-control" name="lang-cvv_ph" maxlength="4"
																			placeholder="7777" />
						            ...
						            <div class="input-with-icon form-group">
										 ...
										 <div class="custom-message-error"></div>
															...
															<div class="form-group" style="display: none;">
																<label for="comments"
																	class="col-sm-3 col-md-4 control-label">Comments:</label>
																<div class="col-sm-6 col-md-4">
																	<textarea placeholder="Write here your comments..."
																		class="form-control" id="comments" name="comments"
																		data-error-icon="icon-exclamation" value="">
			                      </textarea>
																</div>
																<div class="custom-message-error"></div>
															</div>
															<input type="hidden"
																...
																class="form-control2 form-control" id="source"
																placeholder="Source"> <input type="hidden"
																value="ADMIN" class=" form-control" id="medium"
																placeholder="Medium">
															...
															<div
																...
																<div class="form-group">
																	<button class="btn btn-primary btn-block"
																		id="callPurchase" data-user-id="103">Register
																		Purchase</button>
																	<button style="display: none;"
																		class="btn btn-primary btn-block" id="btnFree">Register
																		Purchase</button>
																	<div id="submit-spinner"
																		class="spinner spinner-default spinner-md"
				...
				<div id="massive-customer-form" style="display: none;">
							...
							<div class="col-sm-12">
								<div class="demo-form-wrapper">
									...
									<div id="event-data-massive" class="form form-horizontal">
										...
										<div id="massive-input-container"
										...
										<div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
											<div class="form-group">
												<button class="btn btn-primary btn-block"
													id="registerCustomers">Register Customers</button>
												<div id="submit-spinner-3"
													class="spinner spinner-default spinner-md"
													style="display: none;"></div>
					...
					<div id="massive-errors" class=" row message-error"
						style="display: none;"></div>
				</div>
				<!-- /FORM MASSIVE CUSTOMER -->
	...
	<div class="layout-footer">
		<div class="layout-footer-body">
			<small class="version">Version 1.0.3</small> <small class="copyright">2020
				&copy; <a href="">${title}</a>
			</small>
		</div>
	</div>
	<!-- MODAL SUCCESS body -->
	<div id="successModalAlert" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="text-center">
							...
							<div class="col-sm-7 col-sm-offset-3">
								<div class="input-group">
									...
									<div class="input-group-btn">
										<button id="clipboard-action" class="btn btn-success" title=""
											data-container="body" data-placement="top"
											data-toggle="tooltip" type="button"
											data-original-title="Copy to clipboard"
											data-clipboard-target="#success-tx-id">
						...
						<div class="m-t-lg">
							<button id="success-modal-close" data-user-id="103"
								class="btn btn-success" data-dismiss="modal" type="button">Close</button>
						</div>
					</div>
				</div>
	...
	<!-- //MODAL SUCCESS body -->
	<!-- //MODAL error body -->
	<div id="dangerModalAlert" tabindex="-1" role="dialog"
		class="modal fade in" style="display: none;">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<div class="text-center">
						...
						<div class="m-t-lg">
							<button id="error-modal-close" class="btn btn-danger"
								data-dismiss="modal" type="button">Accept</button>
						</div>
					</div>
				</div>
				<div class="modal-footer"></div>
