				...
				<div class="row gutter-xs" style="margin-top: 30px;">
					<div class="col-xs-12 ">
							...
							<div class="filters" style="">
								...
								<div class="form-group form-group-md has-feedback">
									<label for="payment-method" class="col-sm-1  control-label">Modo de pago:</label>
									<div class="col-sm-9 input-group">
						...
						<div class="form-group form-group-md has-feedback external-payment" style="display: none;">
									<label for="external-payment-method" class="col-sm-1  control-label"></label>
									<div class="col-sm-9 input-group">
...
%>
								...
								<div class="form-group form-group-md has-feedback external-payment" style="display:none;">
									<label for="external-payment-description" class="col-sm-1  control-label">Descripción:</label>
									<div class="col-sm-9 input-group">
									<textarea  class="form-control" id="external-payment-description" name="external-payment-description" placeholder="Descripción">
									</textarea>
									<span class="form-control-feedback" aria-hidden="true">
											<span class="icon"></span>
										  </span>
								...
								<div class="form-group form-group-md has-feedback" >
									<div class="col-sm-9 input-group">
										<label class="custom-control custom-control-primary custom-checkbox">
					                      ...
					                      <span class="custom-control-label">Aplicar cupón</span>
				                    	</label>
									</div>
								</div>
								
								<div id="complimentary-element" class="form-group form-group-md has-feedback" style="display:none;">
									<label for="omplimentary-options" class="col-sm-1  control-label">Complimentary:</label>
									<div class="col-sm-9 input-group">
									<select id="complimentary-options" name='complimentary-options' class="custom-select">
										<option value="free-coupon">Gratis</option>
									</select>
									<span class="form-control-feedback" aria-hidden="true">
											<span class="icon"></span>
										  </span>
							...
							<div class="row stripe-form-elements">
								<div class="col-md-6 ">
									<h4 style="text-align:right; margin: 30px 0;">Datos de pagos</h4>
								</div>
							</div>
							<!-- esto aparte -->
						<div id="stripe-form" class="col-md-11 stripe-form-elements">
							<div class="row gutter-xs">
								 <div class="  form-group form-group-md has-feedback" style="display:flex;">
										...
										<input type="text" id="cardNumber" class="form-control" name="cardNumber" maxlength="20" data-inputmask="'mask': '9999-9999-9999-9999'" required />
										<span class="form-control-feedback" aria-hidden="true">
												<span class="icon"></span>
											  </span>
											  <div class="custom-message-error"></div>
										</div>	
										<label for="lang-expdate_ph" class="col-sm-1  control-label">Vencimiento:</label>
