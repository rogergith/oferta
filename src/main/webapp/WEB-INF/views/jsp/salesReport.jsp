...
<html lang="en">
	<head>
		...
		<spring:url value="/resources/core/mod/salesReport/salesReport.css" var="salesReportCSS" />
		<spring:url value="/resources/core/mod/salesReport/salesReport.js" var="salesReportJS" />
		...
		<link rel="stylesheet" href="${salesReportCSS}">
	...
	<body class="layout layout-header-fixed">
				...
				<div class="layout-content-body">
					<div class="title-bar">
						<h1 class="title-bar-title">
							<span class="d-ib">Comissions Report<small></span>
						...
						<div class="col-xs-12">
							<div class="card">
								...
								<div class="filters" style="padding: 20px 30px 10px 10px;">
									<select id="dateMonths" class="custom-select form-control2 form-control">
										<option value="" selected="selected">Date</option>
									</select> 
									<input type="text" class="form-control2 form-control" id="email" placeholder="Email" style="height: 35px !important;"> 
								</div> 
								<div class="input-with-icon">
									<button class="btn btn-primary" type="button" style="margin-left: 15px;" id="generateSalesReport">
										Generate Report
									</button>
								</div>
		...
		<script src="${salesReportJS}"></script>
	</body>
</html>